...
# Получение ID чата/канала для публикации согласованных постов (может быть None).
# Если не заполнен — публикация отключена, бот не падает.
PUBLICATION_CHAT_ID = os.getenv("PUBLICATION_CHAT_ID")
