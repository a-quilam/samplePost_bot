...
def parse_responsible_callback(data: str | None) -> tuple[int, int] | None:
    """
...
def parse_post_action(data: str | None) -> tuple[str, int] | None:
    """
...
def get_approval(session: Session, draft_id: int) -> PostApproval | None:
...
def assign_responsible(
    session: Session, draft_id: int, telegram_id: int
) -> tuple[PostApproval | None, str]:
    """
...
def decide(
    session: Session, draft_id: int, by_telegram_id: int, new_status: str
) -> tuple[PostApproval | None, str]:
    """
...
def draft_to_post_data(draft: Draft) -> dict[str, str | None]:
    """
...
def publish(
    session: Session, draft_id: int, by_telegram_id: int
) -> tuple[PostApproval | None, str]:
    """
...
def edit_block_reason(session: Session, draft_id: int) -> str | None:
    """
...
def remove_draft(session: Session, draft: Draft | None, by_telegram_id: int) -> str:
    """
